...
main_div.style.gridTemplateColumns="repeat(4,1fr)"
...
products.forEach((v,i,arr)=>{
    ...
    card_container.style.border="1px solid green"
    card_container.style.borderRadius="10px"
    card_container.style.height='300px'
    // card_container.style.width='50%'
    card_container.style.margin='15px'
    card_container.style.padding='15px'
    card_container.style.gap="0px"
    ...
    pro_id.innerHTML=`${v.id}`
    pro_id.style.fontSize='20px'
    pro_id.style.margin='11px'

    let pro_title=document.createElement("p")
    pro_title.innerHTML=`${v.title.slice(0,20)}`
    pro_title.style.fontSize='20px'
    pro_title.style.margin='11px'

    let pro_price=document.createElement("p")
    pro_price.innerHTML=`${v.price}`
    pro_price.style.fontSize='20px'
    pro_price.style.margin='11px'

    let pro_rating=document.createElement("p")
    pro_rating.innerHTML=`${v.rating.rate}`
    pro_rating.style.fontSize='20px'
    pro_rating.style.margin='11px'

    let pro_image=document.createElement("img")
    pro_image.setAttribute("src",v.image)
    pro_image.style.height="120px"
    pro_image.style.width="150px"


    card_container.append(pro_image,pro_id,pro_title,pro_price,pro_rating)
    main_div.append(card_container)
